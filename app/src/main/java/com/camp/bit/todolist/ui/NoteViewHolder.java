...
import com.camp.bit.todolist.beans.BackgroundColor;
...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        //setBackgroundColor(R.color.xxx) is invalid
        int pri = note.getPriority().intValue;
        itemView.setBackgroundColor(Color.parseColor(BackgroundColor.getColor(pri)));
